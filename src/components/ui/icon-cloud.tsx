...
export function IconCloud({ icons, images, slugs }: IconCloudProps) {
  // social store
  ...
  const isMouseOverIcon = (x: number, y: number) => {
  ...
  const handleMouseMove = (e: React.MouseEvent<HTMLCanvasElement>) => {
    ...
    // Cursor logic
    canvasRef.current.style.cursor = isMouseOverIcon(x, y) ? "pointer" : "default";
